          ...
          {session ? (
            <>
              {session.user.role === "ADMIN" ? (
                <li className="py-3">
                  <Link href="/admin" onClick={() => setOpen(false)} className="flex w-full font-medium capitalize">
                    Admin
                  </Link>
                </li>
              ) : null}
              ...
              <li className="py-3">
                <Link href="/dashboard" onClick={() => setOpen(false)} className="flex w-full font-medium capitalize">
                  Dashboard
                </Link>
              </li>
            </>
            ...
            <>
              ...
              <li className="py-3">
                <Link href="/register" onClick={() => setOpen(false)} className="flex w-full font-medium capitalize">
                  Sign up
                </Link>
              </li>
            </>
